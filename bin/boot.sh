...
$APP_ROOT/varnish-7.5.0/sbin/varnishd -C -f $APP_ROOT/etc/varnish/default.vcl 2>&1
...
exec $APP_ROOT/varnish-7.5.0/sbin/varnishd -v

# This actually Executes the Varnish server software. cw 2024-04-29
exec $APP_ROOT/sbin/varnishd -n /home/vcap/tmp/varnish -F -f $APP_ROOT/etc/varnish/default.vcl -a 0.0.0.0:$VCAP_APP_PORT -t 120 -w 50,1000,120 -s malloc,$VARNISH_MEMORY_LIMIT -T 127.0.0.1:6082 -p http_resp_hdr_len=32768 2>&1
